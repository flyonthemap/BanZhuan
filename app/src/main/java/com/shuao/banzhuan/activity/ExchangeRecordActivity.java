...
public class ExchangeRecordActivity extends BaseRecordActivity {
    ...
    protected void initView() {
        ...
        // 加载头部的布局
        headLayout = (LinearLayout)findViewById(R.id.exchange_record_head);
    ...
    protected void initToolbar() {
        Toolbar toolbar = (Toolbar) findViewById(R.id.tl_exchange_record);
    ...
    protected void initHeadTitle() {
        ...
        initHeadHashMap(headMap,"兑换名称");
        initHeadHashMap(headMap,"兑换时间");
        initHeadHashMap(headMap,"处理状态");
