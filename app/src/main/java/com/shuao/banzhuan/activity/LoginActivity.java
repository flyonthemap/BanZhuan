...
import com.shuao.banzhuan.tools.GlideImageLoader;
...
public class LoginActivity extends BaseActivity {
    @BindView(R.id.main_login) RelativeLayout rlMain;
    ...
    @BindView(R.id.iv_portrait) CircleImageView ciPortrait;
...
//                    Log.e(Config.TAG,PHONE + "=" +phoneNum);
                    SPUtils.put(UiTools.getContext(),Config.PHONE,phoneNum);
    ...
    protected void initView() {
        ...
        UiTools.addLayoutListener(rlMain,btnRegister);
    ...
    void login(){
        ...
        if(!MatchUtil.isPhoneNum(phoneNum)){
            ...
            okClientManager.requestPostBySyn(Config.LOGIN_URI, params,new OKClientManager.LoadJsonString() {
                @Override
